...
// ============================================================
  ...
  console.log("🚀 seguranca.js V3 carregado");
...
(function () {
    ...
    // ============================================================
    // 1. FUNÇÃO DE LOGOUT (definida PRIMEIRO)
    // ============================================================
    ...
    // ============================================================
    // 2. BOTÃO DE LOGOUT (dentro da topbar)
    // ============================================================
    ...
    function criarBotaoLogout() {
        ...
        // Usa window.fazerLogout para garantir que existe
    ...
    // ============================================================
    // 4. EXECUTA (ordem importa!)
    // ============================================================

    // Cria botão assim que a página carregar
    if (document.body) {
        criarBotaoLogout();
    } else {
